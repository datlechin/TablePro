...
Mỗi driver là một bundle `.tableplugin` trong `Plugins/`. MySQL và PostgreSQL được tích hợp sẵn trong app bundle; các driver còn lại được phân phối qua plugin registry và tải xuống khi cần.
