...
Each driver is a `.tableplugin` bundle under `Plugins/`. MySQL and PostgreSQL are built into the app bundle; the rest are distributed via the plugin registry and downloaded on demand.
